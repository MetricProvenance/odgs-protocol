...
DIMENSIONS_PATH = "lib/schemas/legislative/standard_dq_dimensions.json"
RULES_PATH = "lib/schemas/judiciary/standard_data_rules.json"
FACTORS_PATH = "lib/schemas/judiciary/root_cause_factors.json"
