...
Organisations can deploy certified framework packs available through a [Metric Provenance certified implementation partner](https://metricprovenance.com/brief). These pre-configured packs map directly to missing conformance requirements and establish deterministic compliance. Partners handle the full delivery — Metric Provenance issues the certified IP layer.

> The [European Data Governance Maturity Benchmark 2026](https://benchmark.metricprovenance.com) scored 99 enterprises across the EU. The average governance maturity was **37.6%** — a 62.4% enforcement gap against regulatory requirements. For executive context on what this means for your organisation, see [metricprovenance.com/brief](https://metricprovenance.com/brief).
